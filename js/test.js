...
// }
  ...
  function searchCha() {
    let word =  document.getElementById('filterInput').value
    fetch(`https://rickandmortyapi.com/api/character/?name=${word}`)
    fetch(`https://rickandmortyapi.com/api/character/?status=${word}`)
    fetch(`https://rickandmortyapi.com/api/character/?species=${word}`)
    fetch(`https://rickandmortyapi.com/api/character/?type=${word}`)
    fetch(`https://rickandmortyapi.com/api/character/?gender=${word}`)
      .then(response => {
        return response.json();
      })
      .then(data => {
